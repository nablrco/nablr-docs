...
It ships 18 expert AI personas - product manager, architect, developer, tester, security owner, and more - each loaded with rules, standards, and escalation protocols. Free tier includes 12 built-in local scanners and workflow tools.
