...
<Card title="ProofRun" icon="flask-conical">
...
<Warning>ProofRun rejects tests that mock the unit under test. A test that only asserts on mock.call_args is not a test - it is a false signal.</Warning>
